      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-orange max-w-none space-y-8 text-orange-900">
          <section>
            ...
            <p>By accessing or using PomPom ("the Service"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service. You must be at least 18 years old to use PomPom.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-orange-950 mb-3">2. Description of Service</h2>
            <p>PomPom is a mystery box platform where users purchase credits ("balance") to open digital mystery boxes containing collectible items. Each box contains one randomly selected physical collectible. Users may choose to have items shipped to them, or sell items back to PomPom at a fixed buyback price.</p>
          </section>
          ...
          <section>
            ...
            <p>You may request a cash withdrawal of your account balance via PayPal, subject to the following conditions: (i) the minimum withdrawal amount is $10 USD; (ii) the maximum withdrawal amount is $500 USD per request; (iii) withdrawals are subject to a 7-day hold from the date of your most recent balance top-up, to protect against payment fraud and chargebacks; (iv) withdrawals are processed within 2–3 business days of approval. PomPom reserves the right to reject withdrawal requests if there is reasonable suspicion of fraudulent activity. PomPom is not responsible for delays caused by PayPal or other payment processors.</p>
          </section>
          ...
          <section>
            ...
            <p>PomPom offers a voluntary buyback program where you may sell your items back to PomPom at the fixed buyback price displayed at time of opening. Buyback prices are set by PomPom and may change without notice. Proceeds are credited to your account balance. You may then withdraw that balance per Section 4a or spend it on additional boxes.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-orange-950 mb-3">7. Shipping</h2>
            <p>Physical shipping is available for items in your collection. Processing times are 3–7 business days. Shipping fees may apply. PomPom is not responsible for delays caused by carriers. Risk of loss transfers to you upon carrier pickup.</p>
          </section>
          ...
          <section>
            ...
            <p>PomPom's liability is limited to the amount you paid for the current transaction. We are not liable for indirect, incidental, or consequential damages. The Service is provided "as is" without warranties of any kind.</p>
          </section>
          ...
          <section>
            ...
            <p>For questions about these Terms, contact us at <a href="mailto:support@pompom.shop" className="text-orange-600 hover:underline">support@pompom.shop</a>.</p>
          </section>
        </div>
